...
function generateEvents(event) {
    return `
  ${event.name}(${generateEventTypes(event.inputs)}): TypedEventFilter<${types_1.generateOutputTypes(true, event.inputs.map((input, i) => { var _a; return ({ name: (_a = input.name) !== null && _a !== void 0 ? _a : 'arg' + i, type: input.type }); })).replace(' &', ',')}>;
`;
}
